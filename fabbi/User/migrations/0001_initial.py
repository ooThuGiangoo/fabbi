    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prefecture_id', models.ForeignKey(blank=True, max_length=11, null=True, on_delete=django.db.models.deletion.SET_NULL, to='MasterData.prefectures')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('mgmt_portal_user_id', models.AutoField(primary_key=True, serialize=False)),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('client_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='User.client')),
            ],
        ),
        migrations.CreateModel(
            name='Image_path',
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('box_notification_trans_content_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='MasterData.box_notification_trans_content')),
