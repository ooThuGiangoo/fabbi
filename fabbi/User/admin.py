...
from .models import Host_user_link, Image_paths, Mgmt_portal_user, User_additional_profile, User_stamps, Users,Clients,Prefectures
...
admin.site.register(User_stamps)
