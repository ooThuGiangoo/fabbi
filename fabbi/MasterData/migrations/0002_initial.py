...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='MasterData.box_notification_master_content'),
        ),
        migrations.AddField(
            model_name='box_notification',
            name='box_notification_trans_content_id',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='MasterData.box_notification_trans_content'),
        ),
        migrations.AddField(
            model_name='box_notification',
            name='user_id',
